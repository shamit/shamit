...
# -*- coding: utf-8 -*-
#
# shambrain documentation build configuration file, created by
...
htmlhelp_basename = 'shambraindoc'
...
latex_documents = [
  ('index', 'shambrain.tex', 'shambrain Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'shambrain', 'shambrain Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'shambrain', 'shambrain Documentation',
   'Ariel Rokem', 'shambrain', 'One line description of project.',
   'Miscellaneous'),
]
